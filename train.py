...
'''
八个参数：
net:网络结构 resnet50 或 resnet50
dataset:数据集 cifar10 或 imagenet2012 或 rp2k
...
parser.add_argument('--dataset', type=str, default='rp2k', help='Dataset, cifar10 or imagenet2012 or rp2k')
